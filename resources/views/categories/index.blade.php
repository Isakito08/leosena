   ...
   <div class="card" style="position: relative" style="margin-left: 10rem">
       ...
       <tbody>
           ...
           <tr>
               ...
               <td>
                   <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModale{{ $category->id }}">
                       Eliminar
                   </button>
               </td>
           </tr>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('categories') }}" method="post">
                    @csrf
                        <div class="">
                            <label for="name" class="col-sm-2 col-form-label">Nombre categoria:</label>
                            <div class="">
                        ...
                        <div class="">
                            <label for="slug" class="col-sm-2 col-form-label">Slug categoria:</label>
                            <div class="">
